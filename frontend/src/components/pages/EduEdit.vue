    ...
    <div class="main-container">
      <div class="educations-card">
        ...
        <div class="education-edit">
          <Form ref="eduEditForm" :model="eduEditForm" :rules="editRules" label-position="top">
...
export default {
  ...
  methods: {
    ...
    handleSubmit () {
      let startTime = this.eduEditForm.startYear + '/' + this.eduEditForm.startMonth
      let endTime = this.eduEditForm.endYear + '/' + this.eduEditForm.endMonth
      this.sendEdu.time = startTime + '-' + endTime
      this.sendEdu.major = this.eduEditForm.major
      this.sendEdu.school = this.eduEditForm.school
      this.sendEdu.stage = this.eduEditForm.stage
      console.log(this.sendEdu)
      this.$axios({
        url: '/updateEdu',
        method: 'post',
        data: this.sendEdu
